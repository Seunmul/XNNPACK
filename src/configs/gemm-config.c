...
static void init_f32_gemm_config_impl(struct xnn_gemm_config* f32_gemm_config, bool consistent_arithmetic) {
    ...
    if ((hardware_config->arch_flags & xnn_arch_x86_fma3)) {
      switch (hardware_config->uarch[XNN_UARCH_INDEX]) {
        ...
        //   f32_gemm_config->cache_info.gemm_ukernel_names[XNN_MR_TO_INDEX(1)] = "xnn_f32_gemm_minmax_ukernel_1x16s4__fma3_broadcast";
        //   f32_gemm_config->cache_info.gemm_ukernel_names[XNN_MR_TO_INDEX(4)] = "xnn_f32_gemm_minmax_ukernel_4x16s4__fma3_broadcast";
        //   f32_gemm_config->cache_info.gemm_ukernel_macro_name = "XNN_INIT_HMP_GEMM_UKERNEL";
        //   f32_gemm_config->cache_info.init_name = "xnn_init_f32_minmax_scalar_params";
        //   f32_gemm_config->cache_info.pack_gemm_gio_fn_name = "xnn_pack_f32_gemm_gio_w";
        //   f32_gemm_config->cache_info.pack_gemm_goi_fn_name = "xnn_x32_packw_gemm_goi_ukernel_x16s4__avx_u4";
...
// [통합 목록] 모든 GEMM 설정 조합을 이 목록 하나로 관리합니다.
static const struct gemm_config_candidate f32_config_candidates[] = {
#if XNN_ARCH_X86 || XNN_ARCH_X86_64
    { 
        .gemm_ukernel_name = "xnn_f32_gemm_minmax_ukernel_1x16__fma3_broadcast",
        .gemm_ukernel = xnn_f32_gemm_minmax_ukernel_1x16__fma3_broadcast,
        .mr = 1, .nr = 16, .log2_kr = 0, .log2_sr = 0,
        .init_fn_name = "xnn_init_f32_minmax_scalar_params",
        .init_fn = xnn_init_f32_minmax_scalar_params,
        .pack_gio_fn_name = "xnn_x32_packw_gemm_gio_ukernel_x16__avx_u8",
        .pack_gio_fn = xnn_x32_packw_gemm_gio_ukernel_x16__avx_u8,
        .pack_goi_fn_name = "xnn_x32_packw_gemm_goi_ukernel_x16__avx_u4",
        .pack_goi_fn = xnn_x32_packw_gemm_goi_ukernel_x16__avx_u4,
    },
    {
        .gemm_ukernel_name = "xnn_f32_gemm_minmax_ukernel_2x16__fma3_broadcast",
        .gemm_ukernel = xnn_f32_gemm_minmax_ukernel_2x16__fma3_broadcast,
    ...
    {
        .gemm_ukernel_name = "xnn_f32_gemm_minmax_ukernel_4x16__fma3_broadcast",
        .gemm_ukernel = xnn_f32_gemm_minmax_ukernel_4x16__fma3_broadcast,
    ...
    {
        .gemm_ukernel_name = "xnn_f32_gemm_minmax_ukernel_5x16__fma3_broadcast",
        .gemm_ukernel = xnn_f32_gemm_minmax_ukernel_5x16__fma3_broadcast,
    ...
    {
        .gemm_ukernel_name = "xnn_f32_gemm_minmax_ukernel_6x16__fma3_broadcast",
        .gemm_ukernel = xnn_f32_gemm_minmax_ukernel_6x16__fma3_broadcast,
    ...
    #if XNN_ENABLE_ASSEMBLY && !XNN_PLATFORM_IOS && !XNN_PLATFORM_MAC
    {
        .gemm_ukernel_name="xnn_f32_gemm_minmax_ukernel_1x8__asm_aarch64_neonfma_cortex_a53_prfm",
        .gemm_ukernel = xnn_f32_gemm_minmax_ukernel_1x8__asm_aarch64_neonfma_cortex_a53_prfm,
        .mr = 1, .nr = 8, .log2_kr = 0, .log2_sr = 0,
        .init_fn_name = "xnn_init_f32_minmax_scalar_params",
        .init_fn = xnn_init_f32_minmax_scalar_params,
        .pack_gio_fn_name = "xnn_pack_f32_gemm_gio_w",
        .pack_gio_fn = (xnn_packw_gemm_gio_ukernel_fn) xnn_pack_f32_gemm_gio_w,
        .pack_goi_fn_name = "xnn_x32_packw_gemm_goi_ukernel_x8__neon_ld4lane_u4_prfm",
        .pack_goi_fn = xnn_x32_packw_gemm_goi_ukernel_x8__neon_ld4lane_u4_prfm,
    },
    {
        .gemm_ukernel_name="xnn_f32_gemm_minmax_ukernel_1x12__asm_aarch64_neonfma_cortex_a53_prfm",
        .gemm_ukernel = xnn_f32_gemm_minmax_ukernel_1x12__asm_aarch64_neonfma_cortex_a53_prfm,
        .mr = 1, .nr = 12, .log2_kr = 0, .log2_sr = 0,
        .init_fn_name = "xnn_init_f32_minmax_scalar_params",
        .init_fn = xnn_init_f32_minmax_scalar_params,
        .pack_gio_fn_name = "xnn_pack_f32_gemm_gio_w",
        .pack_gio_fn = (xnn_packw_gemm_gio_ukernel_fn) xnn_pack_f32_gemm_gio_w,
        .pack_goi_fn_name = "xnn_x32_packw_gemm_goi_ukernel_x12__neon_ld4lane_u4_prfm",
        .pack_goi_fn = xnn_x32_packw_gemm_goi_ukernel_x12__neon_ld4lane_u4_prfm,
    },
    {
        .gemm_ukernel_name="xnn_f32_gemm_minmax_ukernel_4x8__asm_aarch64_neonfma_cortex_a53_prfm",
        .gemm_ukernel = xnn_f32_gemm_minmax_ukernel_4x8__asm_aarch64_neonfma_cortex_a53_prfm,
    ...
    {
        .gemm_ukernel_name="xnn_f32_gemm_minmax_ukernel_4x12__asm_aarch64_neonfma_cortex_a53_prfm",
        .gemm_ukernel = xnn_f32_gemm_minmax_ukernel_4x12__asm_aarch64_neonfma_cortex_a53_prfm,
        .mr = 4, .nr = 12, .log2_kr = 0, .log2_sr = 0,
        .init_fn_name = "xnn_init_f32_minmax_scalar_params",
        .init_fn = xnn_init_f32_minmax_scalar_params,
        .pack_gio_fn_name = "xnn_pack_f32_gemm_gio_w",
        .pack_gio_fn = (xnn_packw_gemm_gio_ukernel_fn) xnn_pack_f32_gemm_gio_w,
    ...
    {
        .gemm_ukernel_name="xnn_f32_gemm_minmax_ukernel_4x12__asm_aarch64_neonfma_cortex_a53_prfm_pack8",
        .gemm_ukernel = xnn_f32_gemm_minmax_ukernel_4x12__asm_aarch64_neonfma_cortex_a53_prfm,
        .mr = 4, .nr = 12, .log2_kr = 0, .log2_sr = 0,
        .init_fn_name = "xnn_init_f32_minmax_scalar_params",
        .init_fn = xnn_init_f32_minmax_scalar_params,
        .pack_gio_fn_name = "xnn_pack_f32_gemm_gio_w",
        .pack_gio_fn = (xnn_packw_gemm_gio_ukernel_fn) xnn_pack_f32_gemm_gio_w,
        .pack_goi_fn_name = "xnn_x32_packw_gemm_goi_ukernel_x12__neon_ld4lane_u8_prfm",
        .pack_goi_fn = xnn_x32_packw_gemm_goi_ukernel_x12__neon_ld4lane_u8_prfm,
    },
    {
        .gemm_ukernel_name="xnn_f32_gemm_minmax_ukernel_5x8__asm_aarch64_neonfma_cortex_a53_prfm",
        .gemm_ukernel = xnn_f32_gemm_minmax_ukernel_5x8__asm_aarch64_neonfma_cortex_a53_prfm,
    ...
    {
        .gemm_ukernel_name="xnn_f32_gemm_minmax_ukernel_6x8__asm_aarch64_neonfma_cortex_a53_prfm",
        .gemm_ukernel = xnn_f32_gemm_minmax_ukernel_6x8__asm_aarch64_neonfma_cortex_a53_prfm,
    ...
    {
        .gemm_ukernel_name="xnn_f32_gemm_minmax_ukernel_6x8__asm_aarch64_neonfma_cortex_a53_prfm_pack8",
        .gemm_ukernel = xnn_f32_gemm_minmax_ukernel_6x8__asm_aarch64_neonfma_cortex_a53_prfm,
        .mr = 6, .nr = 8, .log2_kr = 0, .log2_sr = 0,
        .init_fn_name = "xnn_init_f32_minmax_scalar_params",
        .init_fn = xnn_init_f32_minmax_scalar_params,
        .pack_gio_fn_name = "xnn_pack_f32_gemm_gio_w",
        .pack_gio_fn = (xnn_packw_gemm_gio_ukernel_fn) xnn_pack_f32_gemm_gio_w,
        .pack_goi_fn_name = "xnn_x32_packw_gemm_goi_ukernel_x8__neon_ld4lane_u8_prfm",
        .pack_goi_fn = xnn_x32_packw_gemm_goi_ukernel_x8__neon_ld4lane_u8_prfm,
    },
    // {
    //     .gemm_ukernel_name="xnn_f32_gemm_minmax_ukernel_6x8__asm_aarch64_neonfma_ld64_2",
    //     .gemm_ukernel = xnn_f32_gemm_minmax_ukernel_6x8__asm_aarch64_neonfma_ld64_2,
    //     .mr = 6, .nr = 8, .log2_kr = 0, .log2_sr = 0,
    //     .init_fn_name = "xnn_init_f32_minmax_scalar_params",
    //     .init_fn = xnn_init_f32_minmax_scalar_params,
    //     .pack_gio_fn_name = "xnn_pack_f32_gemm_gio_w",
    ...
    // },
    // {
    //     .gemm_ukernel_name="xnn_f32_gemm_minmax_ukernel_6x8__asm_aarch64_neonfma_ld128_2",
    //     .gemm_ukernel = xnn_f32_gemm_minmax_ukernel_6x8__asm_aarch64_neonfma_ld128_2,
    //     .mr = 6, .nr = 8, .log2_kr = 0, .log2_sr = 0,
    //     .init_fn_name = "xnn_init_f32_minmax_scalar_params",
    //     .init_fn = xnn_init_f32_minmax_scalar_params,
    //     .pack_gio_fn_name = "xnn_pack_f32_gemm_gio_w",
    ...
    // },
    // {
    //     .gemm_ukernel_name="xnn_f32_gemm_minmax_ukernel_8x8__asm_aarch64_neonfma_ld64_2",
    //     .gemm_ukernel = xnn_f32_gemm_minmax_ukernel_8x8__asm_aarch64_neonfma_ld64_2,
    ...
    // },
    // {
    //     .gemm_ukernel_name="xnn_f32_gemm_minmax_ukernel_8x8__asm_aarch64_neonfma_ld128_2",
    //     .gemm_ukernel = xnn_f32_gemm_minmax_ukernel_8x8__asm_aarch64_neonfma_ld128_2,
    //     .mr = 8, .nr = 8, .log2_kr = 0, .log2_sr = 0,
    //     .init_fn_name = "xnn_init_f32_minmax_scalar_params",
    //     .init_fn = xnn_init_f32_minmax_scalar_params,
    //     .pack_gio_fn_name = "xnn_pack_f32_gemm_gio_w",
...
void* find_function_by_name(const char* name) {
    ...
    // f32_config_candidates 배열을 처음부터 끝까지 순회합니다.
    for (size_t i = 0; f32_config_candidates[i].gemm_ukernel_name != NULL; ++i) {
        const struct gemm_config_candidate* candidate = &f32_config_candidates[i];

        // 1. GEMM 커널 이름과 일치하는지 확인
        if (strcmp(candidate->gemm_ukernel_name, name) == 0) {
            return (void*)candidate->gemm_ukernel;
        }
        
        // 2. Init 함수 이름과 일치하는지 확인
        if (strcmp(candidate->init_fn_name, name) == 0) {
            return (void*)candidate->init_fn;
        }
        
        // 3. Pack GOI 함수 이름과 일치하는지 확인
        if (strcmp(candidate->pack_goi_fn_name, name) == 0) {
            return (void*)candidate->pack_goi_fn;
        }

        // 4. Pack GIO 함수 이름과 일치하는지 확인
        if (strcmp(candidate->pack_gio_fn_name, name) == 0) {
            return (void*)candidate->pack_gio_fn;
        }
    }

    // 배열 전체를 검색했는데도 함수를 찾지 못하면 NULL을 반환합니다.
    xnn_log_error("Function '%s' not found in any candidates.", name);
    return NULL;
}
